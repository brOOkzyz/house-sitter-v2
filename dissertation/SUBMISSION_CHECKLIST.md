...
- [x] Final title locked: *RaPToR-Lite: A Capability-Grounded Natural-Language Task Creation and Verification Layer for ROS 2 Robots — A House-Sitter Case Study*
- [x] Abstract: 277 words (maximum 300)
- [x] Template-defined report word count: 11587
- [x] Approximate main-body prose word count: 10378
- [x] References: 60 verified entries, first-author alphabetical numbering
- [x] Sections: 6 top-level, 43 numbered subsections
- [x] Tables: 3; figures: 8 (6 main, 2 supplementary)
...
- [x] DOCX/PDF generation and structural validation: PASS
- [x] PDF font inspection: PASS with Linux substitutions explicitly recorded
